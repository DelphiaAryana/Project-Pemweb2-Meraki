                ...
                <div class="col-md-5 border rounded mt-2">
                    <form action="{{ route('admin.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('emailInput') is-invalid @enderror" id="email" name="email" value="">                         
                        </div>
                        ...
                        <div class="row mx-2">
                            <button type="submit" class="btn btn-primary mb-3" onclick="tambah()">Tambah</button>
                        </div>
