...
<html lang="en">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5 shifted">
        ...
        <h3 class="text-center">Edit Data Score Pengguna</h3>
        <p class="text-center" style="color: red">Nama pengguna tidak dapat diedit.</p>
        <div class="container ">
            <div class="row justify-content-center">
                <div class="col-md-5 border rounded mt-2">
                    <form action="{{ route('data_point.update', $poin->id) }}" method="POST">
                        @method('put')
                        @csrf
                        <div class="mb-3">
                            <label for="id_user" class="form-label">Nama</label>
                            <input type="text" class="form-control" id="id_user" name="id_user" value="{{ $poin->name }}" readonly>
                        </div>

                        <div class="mb-3">
                            <label for="score" class="form-label">Score</label>
                            <input type="text" class="form-control" id="score" name="score" value="{{ $poin->poin_kuis }}">                         
                        </div>
