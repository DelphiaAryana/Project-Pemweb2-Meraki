...
<html lang="en">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5 shifted">
        ...
        <h3 class="text-center">Edit Data Style</h3>
        <div class="container ">
            <div class="row justify-content-center">
                <div class="col-md-5 border rounded mt-2">
                    <form action="{{ route('data_style.update', $style->id) }}" method="POST" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="mb-3">
                            <label for="jenis" class="form-label">Jenis Pakaian</label>
                            <input type="text" class="form-control" id="jenis" name="jenis" value="{{ $style->jenis }}">
                        </div>

                        <div class="mb-3">
                          <label for="image" class="form-label">Upload Gambar</label>
                          <input type="file" class="form-control" id="image" name="image" value="{{ $style->image }}">                         
                        </div>
